    ...
    public static class IngresoDatos
    {
        public static string PedirCharEnRango(string mensaje, char char1, char char2)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Tecla Ingresada no valida!!!");
            } while (true);
        ...
        public static string PedirString(string mensaje)
        {
            ...
            do
            {
                Console.Write(mensaje);
                cX = Console.ReadLine();
                if (!string.IsNullOrEmpty(cX) || !string.IsNullOrEmpty(cX))
                {
                    break;
                }
        ...
        public static int PedirIntEnRango(string mensaje, int valorMenor, int valorMayor)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine($"ERROR valor fuera del rango perimitido {valorMenor}-{valorMayor} ");
                }
                else
                {
                    error = false;
